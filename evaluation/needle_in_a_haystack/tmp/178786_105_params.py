datasets = [
    [
        dict(
            abbr='Length1000Depth26_4needle_zh_4k',
            depth=26,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length1000Depth31_4needle_zh_4k',
            depth=31,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth36_4needle_zh_4k',
            depth=36,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth42_4needle_zh_4k',
            depth=42,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth47_4needle_zh_4k',
            depth=47,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
