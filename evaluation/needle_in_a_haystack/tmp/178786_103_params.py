datasets = [
    [
        dict(
            abbr='Length4000Depth78_3needle_zh_4k',
            depth=78,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length4000Depth84_3needle_zh_4k',
            depth=84,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth89_3needle_zh_4k',
            depth=89,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth94_3needle_zh_4k',
            depth=94,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth100_3needle_zh_4k',
            depth=100,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
