datasets = [
    [
        dict(
            abbr='Length1000Depth0_4needle_zh_4k',
            depth=0,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length1000Depth5_4needle_zh_4k',
            depth=5,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth10_4needle_zh_4k',
            depth=10,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth15_4needle_zh_4k',
            depth=15,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth21_4needle_zh_4k',
            depth=21,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
