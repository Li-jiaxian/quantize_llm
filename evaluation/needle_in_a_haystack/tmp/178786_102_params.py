datasets = [
    [
        dict(
            abbr='Length4000Depth52_3needle_zh_4k',
            depth=52,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length4000Depth57_3needle_zh_4k',
            depth=57,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth63_3needle_zh_4k',
            depth=63,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth68_3needle_zh_4k',
            depth=68,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length4000Depth73_3needle_zh_4k',
            depth=73,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
