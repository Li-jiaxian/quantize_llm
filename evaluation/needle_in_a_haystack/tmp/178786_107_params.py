datasets = [
    [
        dict(
            abbr='Length1000Depth78_4needle_zh_4k',
            depth=78,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length1000Depth84_4needle_zh_4k',
            depth=84,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth89_4needle_zh_4k',
            depth=89,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth94_4needle_zh_4k',
            depth=94,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth100_4needle_zh_4k',
            depth=100,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
