datasets = [
    [
        dict(
            abbr='Length1000Depth52_4needle_zh_4k',
            depth=52,
            diff=10,
            eval_cfg=dict(
        ...
        dict(
            abbr='Length1000Depth57_4needle_zh_4k',
            depth=57,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth63_4needle_zh_4k',
            depth=63,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth68_4needle_zh_4k',
            depth=68,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
            ...
            'opencompass.datasets.needlebench.multi.NeedleBenchMultiDataset'),
        dict(
            abbr='Length1000Depth73_4needle_zh_4k',
            depth=73,
            diff=10,
            eval_cfg=dict(
                dataset_postprocessor=dict(
