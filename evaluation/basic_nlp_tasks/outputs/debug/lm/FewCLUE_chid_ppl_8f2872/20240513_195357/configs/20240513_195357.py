datasets=[
    dict(abbr='chid-dev',
        data_files='/opt/data/private/ljx/quantize-llm/evaluation/basic_nlp_tasks/data/data/FewCLUE/chid/dev_few_all.json',
        eval_cfg=dict(
            evaluator=dict(
    ...
    dict(abbr='chid-test',
        data_files='/opt/data/private/ljx/quantize-llm/evaluation/basic_nlp_tasks/data/data/FewCLUE/chid/test_public.json',
        eval_cfg=dict(
            evaluator=dict(
                type='opencompass.openicl.icl_evaluator.AccEvaluator')),
        infer_cfg=dict(
...
work_dir='./outputs/debug/lm/FewCLUE_chid_ppl_8f2872/20240513_195357'