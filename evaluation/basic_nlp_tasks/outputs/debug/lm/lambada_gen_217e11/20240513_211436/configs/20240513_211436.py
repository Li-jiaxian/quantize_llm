datasets=[
    dict(abbr='lambada',
        ...
        path='/opt/data/private/ljx/quantize-llm/evaluation/basic_nlp_tasks/data/data/lambada/test.jsonl',
        reader_cfg=dict(
            input_columns=[
                'prompt',
                ],
...
work_dir='./outputs/debug/lm/lambada_gen_217e11/20240513_211436'